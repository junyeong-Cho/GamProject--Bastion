...
set(GAM250_GLEW_INCLUDE_DIR "")
set(GAM250_GLEW_TARGET_NAME "")
if (NOT WIN32 AND NOT EMSCRIPTEN)
    # on    Mac : brew install glew
    # on Ubuntu : apt install libglew-dev
    set(GLEW_USE_STATIC_LIBS TRUE)
    find_package(GLEW REQUIRED)
    set(GAM250_GLEW_INCLUDE_DIR ${GLEW_INCLUDE_DIRS})
    set(GAM250_GLEW_TARGET_NAME GLEW::glew_s)
elseif(WIN32)
    ...
    set(GAM250_GLEW_INCLUDE_DIR ${glew_SOURCE_DIR}/include)
    ...
    set(GAM250_GLEW_TARGET_NAME the_glew)
endif()

add_library(GAM250_glew INTERFACE)
target_link_libraries(GAM250_glew INTERFACE ${GAM250_GLEW_TARGET_NAME} $<$<PLATFORM_ID:Linux>:GL>)
target_include_directories(GAM250_glew SYSTEM INTERFACE ${GAM250_GLEW_INCLUDE_DIR})
target_compile_definitions(GAM250_glew INTERFACE GLEW_STATIC)
