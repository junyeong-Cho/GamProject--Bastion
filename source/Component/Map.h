...
{
public:
    Map() : game_background("assets/Background/game_tile2.png"), blur("assets/Background/blur.png"), ui("assets/Background/ingame_ui.png"), enemy_wave("assets/Background/enemy_wave_ui.png")
	{
