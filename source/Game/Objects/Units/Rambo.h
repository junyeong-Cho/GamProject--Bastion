...
class RamboUnit : public Unit
{
public:
    RamboUnit(double attack_time, int damage, Math::vec2 position = Map::middle_point, double range = Map::basic_size * 2.5);
    ...
    {
        return GameObjectTypes::RangedUnit;
    }
