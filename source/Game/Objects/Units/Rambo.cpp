...
RangedUnit::RangedUnit(double attack_time, int damage, Math::vec2 position, double range) : Unit(attack_time, damage, range, position)
{
...
bool Bow_1::CanMergeWith(GameObjectTypes type)
{
    switch (type)
    {
        case GameObjectTypes::Sword_1: return true;

        case GameObjectTypes::Bow_1: return true;

        case GameObjectTypes::Bomb_1: return true;
...
bool Bow_2::CanMergeWith(GameObjectTypes type)
{
    switch (type)
    {
        case GameObjectTypes::Bow_2: return true;
        default: return false;
    }
}
...
bool Bow_4::CanMergeWith(GameObjectTypes type)
{
    switch (type)
    {
        case GameObjectTypes::Bow_4: return true;
        default: return false;
    }
}
...
bool Bow_8::CanMergeWith(GameObjectTypes type)
{
    switch (type)
    {
        case GameObjectTypes::Bow_8: return true;
        default: return false;
    }
}
