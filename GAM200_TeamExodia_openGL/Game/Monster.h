...
{
public:
	Monster_3() : Monster({ 16, 0, 0, 1.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_3.png"); }
private:
};
...
{
public:
	Monster_4() : Monster({ 24, 0, 0, 1.2 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_4.png"); }
private:
};
...
{
public:
	Monster_5() : Monster({ 30, 0, 0, 1.2 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_5.png"); }
private:
};
...
{
public:
	Monster_6() : Monster({ 75, 0, 0, 1.2 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_6.png"); }
private:
};
...
{
public:
	Monster_11() : Monster({ 50, 0, 0, 2.4 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_11.png"); }
private:
};
...
{
public:
	Monster_12() : Monster({ 80, 0, 0, 2.4 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_12.png"); }
private:
};
...
{
public:
	Monster_13() : Monster({ 100, 0, 0, 2.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_13.png"); }
private:
};
