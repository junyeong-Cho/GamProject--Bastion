...
{
public:
	Monster_6() : Monster({ 60, 0, 0, 1.3 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_6.png"); }
private:
};
...
{
public:
	Monster_7() : Monster({ 80, 0, 0, 1.2 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_7.png"); }
private:
};
...
{
public:
	Monster_8() : Monster({ 5, 0, 0, 2.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_8.png"); }
private:
};
...
{
public:
	Monster_9() : Monster({ 25, 0, 0, 2.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_9.png"); }
private:
};
...
{
public:
	Monster_10() : Monster({ 30, 0, 0, 2.2 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_10.png"); }
private:
};
...
{
public:
	Monster_11() : Monster({ 40, 0, 0, 2.4 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_11.png"); }
private:
};
...
{
public:
	Monster_12() : Monster({ 130, 0, 0, 2.4 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_12.png"); }
private:
};
...
{
public:
	Monster_13() : Monster({ 150, 0, 0, 2.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_13.png"); }
private:
};
...
{
public:
	Monster_14() : Monster({ 180, 0, 0, 2.0 }) { image = Engine::Instance().GetTextureManager().Load("assets/enemy_s2/Monster_14.png"); }
private:
};
