...
set(GAM250_SDL2_INCLUDE_DIR "")
set(GAM250_SDL2_TARGET_NAME "")
set(GAM250_SDL2_COMPILE_OPTIONS "")
if (NOT WIN32 AND NOT EMSCRIPTEN)
    # on    Mac : brew install sdl2
    # on Ubuntu : apt install libsdl2-dev
    find_package(SDL2 REQUIRED)
    set(GAM250_SDL2_INCLUDE_DIR ${SDL2_INCLUDE_DIRS})
    set(GAM250_SDL2_TARGET_NAME ${SDL2_LIBRARIES})
elseif(EMSCRIPTEN)
    find_package(SDL2 REQUIRED)
    set(GAM250_SDL2_TARGET_NAME ${SDL2_LIBRARIES})
    set(GAM250_SDL2_INCLUDE_DIR ${SDL2_INCLUDE_DIRS})
    # USE_SDL=2                     - we want version 2 rather than SDL1
    set(GAM250_SDL2_COMPILE_OPTIONS -sUSE_SDL=2)
else(WIN32)
    ...
    set(GAM250_SDL2_INCLUDE_DIR ${sdl2_SOURCE_DIR}/include)
    ...
    set(GAM250_SDL2_TARGET_NAME the_sdl2)
endif()

add_library(GAM250_sdl2 INTERFACE)
target_link_libraries(GAM250_sdl2 INTERFACE ${GAM250_SDL2_TARGET_NAME})
target_include_directories(GAM250_sdl2 SYSTEM INTERFACE ${GAM250_SDL2_INCLUDE_DIR})
target_compile_options(GAM250_sdl2 INTERFACE ${GAM250_SDL2_COMPILE_OPTIONS})
